...
from creds.apicreds import APP_TOKEN
from creds.dbcredsdev import HOST,USER,PASSWORD
    ...
    def __init__(self, dbname):
        ...
        try:
            ...
            if self.con.is_connected():
                ...
                #  If the specified database exists, connect to it. Otherwise, create it then connect.
